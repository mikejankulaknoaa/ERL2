...
class Erl2prototype:
    ...
    def __init__(self, root):
        ...
        # try out this tkinter Style class
        s = ttk.Style()
        s.configure('TNotebook',tabposition='w')
        #s.configure('TNotebook.Tab',font='Arial 16')

        # let's make this into a tabbed-pages prototype
        notebook = ttk.Notebook(root)
        notebook.grid(column=1, row=1, sticky='nwse')
        notebook.columnconfigure(1, weight=1)
        notebook.rowconfigure(1, weight=1)

        overviewpage = ttk.Frame(notebook, padding= '8 4')
        tab1 = notebook.add(overviewpage,image=labeloverview)

        temppage = ttk.Frame(notebook)
        notebook.add(temppage,image=labeltemp)

        phpage = ttk.Frame(notebook)
        notebook.add(phpage,image=labelph)

        o2page = ttk.Frame(notebook)
        notebook.add(o2page,image=labelo2)

        debugpage = ttk.Frame(notebook)
        notebook.add(debugpage,image=labeldebug)
        ...
        mainframe = ttk.Frame(overviewpage, padding='8 4')
...
labeloverview = PhotoImage(file='/home/ocedadmin/Desktop/img/label_Overview.png')
labeltemp = PhotoImage(file='/home/ocedadmin/Desktop/img/label_Temperature.png')
labelph = PhotoImage(file='/home/ocedadmin/Desktop/img/label_pH.png')
labelo2 = PhotoImage(file='/home/ocedadmin/Desktop/img/label_Oxygen.png')
labeldebug = PhotoImage(file='/home/ocedadmin/Desktop/img/label_Debug.png')
