...
class erl2prototype:
    ...
    def __init__(self, root):
        ...
        h0exitframe = ttk.Frame(headerframe, padding='2 0', relief='solid', borderwidth=1)
        h0exitframe.grid(column=1, row=1, padx='2', sticky='nwse')
        exitbutton = Button(h0exitframe, image=exit25, bd=0, command=exitprototype)
        exitbutton.grid(column=1, row=1, stick='ns')
        exitbutton.image = exit25
        h0exitframe.columnconfigure(1,weight=1)
        h0exitframe.rowconfigure(1,weight=1)
